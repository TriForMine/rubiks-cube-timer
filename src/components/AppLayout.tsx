...
const sidebarItems = [
	...
	},
	{
		...
		label: "Scramble Practice",
		icon: Target,
		description: "Learn scrambles with 3D",
			...
			<div className="p-6 pb-4 border-b border-border/50">
				<div className="flex items-center space-x-3">
					...
					<div className="flex-1">
						...
						<p className="text-sm text-muted-foreground font-medium">Speedcubing Practice</p>
					</div>
				</div>
			</div>
			...
			<div className="flex-1 overflow-hidden">
				<ScrollArea className="h-full px-4 py-6">
					...
					<div className="mt-8 space-y-4">
						<DailyProgress sessionStats={sessionStats} />
					</div>
			...
			<div className="p-6 pt-4 border-t border-border/50 bg-muted/20">
				<div className="text-center space-y-2">
					<div className="flex items-center justify-center gap-2">
						...
						<p className="text-xs font-semibold text-foreground">CubeTimer v0.1.0</p>
					</div>
...
export function AppLayout({ children, activeTab, onTabChange, sessionStats }: AppLayoutProps) {
	...
	return (
		<div className="h-screen flex bg-gradient-to-br from-background via-background to-muted/30 overflow-hidden">
			...
			<Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
				<SheetContent side="left" className="w-80 p-0 bg-card/95 backdrop-blur-md border-border/50">
				...
				<header className="h-16 border-b border-border/50 bg-card/50 backdrop-blur-md supports-[backdrop-filter]:bg-card/30 z-10 shadow-sm">
					<div className="flex h-full items-center justify-between px-6">
							...
							<div className="flex items-center space-x-3">
								...
								<div className="space-y-1">
									...
									<p className="text-sm text-muted-foreground hidden sm:block">
										{activeTab === "timer" && "Practice your solves with precision timing"}
										{activeTab === "scramble-practice" &&
											"Learn scrambles with 3D step-by-step visualization"}
										{activeTab === "statistics" && "Track your progress and improvements"}
										{activeTab === "times" && "View and manage your solve history"}
						...
						<div className="flex items-center space-x-4">
							...
							{activeTab === "timer" && sessionStats && sessionStats.count > 0 && (
							...
							<Separator orientation="vertical" className="h-6 hidden md:block opacity-50" />
