...
export function PBCelebration({
	...
	const [animationPhase, setAnimationPhase] = useState<"entrance" | "celebration" | "exit">(
		"entrance"
	);
			...
			>
				...
				<div className="text-center space-y-4">
					...
					<div className="space-y-2">
						...
						<p className="text-lg font-semibold text-white/80">{getImprovementMessage()}</p>
					</div>
					...
					<div className="pt-4">
						...
						{getCelebrationLevel() === "great" && (
							<p className="text-white/70 text-sm">💪 Great progress! Every second counts!</p>
						)}
						{getCelebrationLevel() === "nice" && (
							<p className="text-white/70 text-sm">🎯 Nice improvement! Consistency is key!</p>
						)}
					</div>
