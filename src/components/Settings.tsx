...
export function Settings({
  ...
  const updateDailySetting = <K extends keyof DailySettings>(
    key: K,
    value: DailySettings[K],
  ) => {
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) =>
                    updateDailySetting("dailyGoal", Number(e.target.value))
                  }
                  className="w-full h-2 bg-muted rounded-lg appearance-none cursor-pointer slider"
                  style={{
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) =>
                    updateDailySetting("streakGoal", Number(e.target.value))
                  }
                  className="w-full h-2 bg-muted rounded-lg appearance-none cursor-pointer slider"
                  style={{
