...
import { formatTimeWithSettings, getTimeColor, cn } from "@/lib/utils";
...
export function TimesList({
  ...
  const formatTimeWithPenalty = (time: TimeRecord) => {
    ...
    const formatted = formatTimeWithSettings(
      baseTime,
      showMilliseconds,
      timeFormat,
    );
  ...
  const handlePenaltyToggle = (time: TimeRecord) => {
    if (time.penalty === "DNF") {
      ...
      setTimeout(
        () => onAddPenalty(time.id, undefined as unknown as "DNF" | "+2"),
        50,
      );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Your solve records and statistics
                </p>
              </div>
            </div>
          </CardHeader>
            ...
            <div className="max-w-md mx-auto space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Start solving to build your times history! Every solve will be
                  recorded here with detailed statistics.
                </p>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) =>
                  setFilterPenalty(
                    e.target.value as "all" | "clean" | "penalty",
                  )
                }
              ...
              {expandedTime === time.id && (
                <div className="mt-6 pt-6 border-t border-border space-y-6 animate-fade-in">
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    ...
                    <Button
                      variant={
                        time.penalty === "DNF" ? "destructive" : "outline"
                      }
                      size="sm"
                      onClick={(e) => {
                        e.stopPropagation();
                    ...
                    <Button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        if (
                          confirm("Are you sure you want to delete this time?")
                        ) {
